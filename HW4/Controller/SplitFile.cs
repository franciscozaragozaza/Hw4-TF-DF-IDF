                ...
                try
                {
                    if (splittedCollection1[i] != null)
                    {
                        if (splittedCollection1[i].IndexOf("\r\n") == -1)
                        {
                            ...
                            matrix[i, 1] = splittedCollection1[i].Substring(aux2, aux - aux2 - 1).Replace("\n", " ");
                            ...
                            matrix[i, 2] = splittedCollection1[i].Substring(aux + 1, splittedCollection1[i].Length - (aux + 2)).Replace("\n", " ");
                        }
